...
const CurrenciesOrg = ({ theme }: ICurrenciesProps) => {
    ...
    <>
      {loading ? (
        ...
        <>
          ...
          <StyledChartName>1 BTC is worth</StyledChartName>
          <StyledTable>
            <thead>
              <tr>
